...
const MatchQuestion = ({width, questionID, question, optionsLeft, optionsRight, setState, isModal, answer, isAuthor, deleteFunction, increaseAnswerCount}) => {
    ...
    return (
        <div className={`w-${width} ${!isModal && "my-3"} p-4 border ${ isCorrect === undefined ? "border-gray-300" : isCorrect ? "border-green-500" : "border-red-500"} rounded-lg`}>
